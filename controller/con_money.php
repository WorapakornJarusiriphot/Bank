...
<body>
    ...
    <header class="bg-or-5 py-1 bg-header-img">
            <div class="container-fluid px-4 px-lg-5 my-5">
                <div class="text-center orange-theme-4">
                    <h1 class="display-4 fw-bolder">โอนเงิน</h1>
                    <p class="lead fw-normal text-50 mb-0">บัญชีเงินฝากออมทรัพย์</p>
                </div>
            </div>
    </header>
    ...
    <br>
    <img src="../images/โอนเงิน.png" class="rounded mx-auto d-block" alt="..." width="450px" height="450px">
    <div class="card-body">
        <h5 class="card-title">โอนเงินเรียบร้อยแล้ว</h5>
        
        <br>
        <a href="../index0.php" class="btn btn-primary">กลับสู่หน้าหลัก</a>
    </div>
    <br>
    <br>
    </div>
